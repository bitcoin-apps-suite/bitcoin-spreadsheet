      ...
      >
        ...
        <section className="philosophy-section">
          ...
          <div className="philosophy-content">
            <p>
              Bitcoin Spreadsheet is an <strong>open-source project</strong> licensed under MIT and BSV licenses. 
          ...
          <div className="model-card">
            ...
            <ul>
              ...
              <li>
                ...
                dividends to token holders from subscription revenues and spreadsheet exchange fees
              </li>
              <li>
        ...
        <section className="business-section">
          ...
          <div className="business-content">
            <p className="intro">
              Our vision is to create sustainable open-source spreadsheet software through a hybrid model that 
              preserves freedom while generating value from blockchain integration.
            </p>
            ...
            <div className="business-model">
              ...
              <div className="revenue-streams">
                ...
                <div className="stream featured">
                  <h4>Pro Tier</h4>
                  <p>Hosted service, blockchain storage</p>
              ...
              <h3 style={{marginTop: '40px'}}>Spreadsheet Exchange Revenue</h3>
              <div className="revenue-streams">
                <div className="stream">
                  <h4>Data Sales</h4>
                  <p>Users tokenize & sell spreadsheets</p>
                  <p className="price">2.5% fee</p>
                </div>
                <div className="stream featured">
                  <h4>Template Market</h4>
                  <p>Premium spreadsheet templates</p>
                  <p className="price">1.5% fee</p>
                </div>
                <div className="stream">
                  <h4>NFT Spreadsheets</h4>
                  <p>Unique data visualizations & reports</p>
            ...
            <div className="value-flow">
              ...
              <p style={{textAlign: 'center', marginTop: '20px', fontSize: '14px', color: 'rgba(255, 255, 255, 0.6)'}}>
                The Bitcoin Spreadsheet Exchange enables users to tokenize, sell shares, and trade their spreadsheets,
        ...
        <section className="contribute-section">
          ...
          <div className="contribution-examples">
            <h3>What We Value</h3>
            <ul>
              <li>✅ Spreadsheet engine improvements</li>
              <li>✅ Formula & function implementations</li>
              <li>✅ Blockchain integration features</li>
